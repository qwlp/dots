...
BarWidget {
  ...
  readonly property int verticalLineHeight: Style.space(20)
  ...
  WidgetButton {
    ...
    fixedHeight: root.vertical ? root.verticalLines.length * root.verticalLineHeight : -1
    horizontalMargin: 8.75
    verticalPadding: root.vertical ? 0 : 8.75
