...
Panel {
  ...
  // Quickshell already exposes PipeWire's effective default sink. The old
  // host resolved a separate DSP/tuning sink through an external helper;
  // keeping that indirection without the helper created a binding loop.
